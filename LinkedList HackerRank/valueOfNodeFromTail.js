...
function getNode(llist, positionFromTail) {
  ...
  return cache[cache.length - positionFromTail - 1]
}

const llist = new SinglyLinkedListNode(3)
llist.next = new SinglyLinkedListNode(2)
llist.next.next = new SinglyLinkedListNode(1)
llist.next.next.next = new SinglyLinkedListNode(0)

console.log(getNode(llist, 2))
